...
/**
 * Represents a client data model document entity.
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
@EqualsAndHashCode(callSuper = true)
@ToString
public class ClientDocument extends ClientEntity implements IClientDocument
{
    /**
     * Document type.
     */
    ...
    @Getter
    //@Transient -> see: import org.springframework.data.annotation.Transient;
    @JsonIgnore
    @ToString.Exclude
     ...
     */
    public ClientDocument(final @NonNull EntityIdentity parentIdentity, final @NonNull DocumentType documentType)
    {
        super(EntityType.DOCUMENT);
