 ...
 * -----------------------------------------------------------------------------------------------
 */
package com.hemajoo.commerce.cherry.server.shared.data.model.entity.document.exception;
...
/**
 * Exception thrown to indicate an error occurred with a document store (File system, AWS S3 bucket, etc.).
