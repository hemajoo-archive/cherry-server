 ...
 * -----------------------------------------------------------------------------------------------
 */
package com.hemajoo.commerce.cherry.server.data.model.document;
...
public class ServerDocument extends ServerEntity implements IServerDocument
{
    /**
     * Document type.
     */
     ...
     */
    public ServerDocument(final @NonNull ServerEntity owner, final @NonNull DocumentType documentType) throws DocumentException
    {
        super(EntityType.DOCUMENT);
     ...
     */
    public ServerDocument(final @NonNull ServerEntity owner, final @NonNull DocumentType documentType, final @NonNull String filename) throws DocumentException
    {
     ...
     * @throws DocumentException Thrown in case an error occurred while initializing the document.
     */
    public ServerDocument(final @NonNull ServerEntity owner, final @NonNull DocumentType documentType, final @NonNull File file) throws DocumentException
    {
        this(owner, documentType);
     ...
     * @throws DocumentException Thrown in case an error occurred while initializing the document.
     */
    public ServerDocument(final @NonNull ServerEntity owner, final @NonNull DocumentType documentType, final @NonNull MultipartFile multiPartFile) throws DocumentException
    {
        this(owner, documentType);
